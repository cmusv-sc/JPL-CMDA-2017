...
// This was suggested by VonAllmen to calculate the distance with the time difference weighed in
double get_4D_distance(double lat1, double lon1, double lat2, double lon2, double t1, double t2, double w) {

    /*
    printf("--- get_4D_distance() ---\n");
    printf("lat1: %f\n", lat1);
    printf("lon1: %f\n", lon1);
    printf("lat2: %f\n", lat2);
    printf("lon2: %f\n", lon2);
    printf("t1: %f\n", t1);
    printf("t2: %f\n", t2);
    printf("time weight: %f\n", w);
    */

    double r = sqrt((lat1-lat2)*(lat1-lat2) + (lon1-lon2)*(lon1-lon2) + w * (t1-t2)*(t1-t2));
    // printf("get_4D r: %f\n", r);
