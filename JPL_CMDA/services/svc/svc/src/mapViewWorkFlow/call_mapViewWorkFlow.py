...
class call_mapViewWorkFlow:
    ...
    def display_mapViewWorkFlow(self):
...
if __name__ == '__main__':
    c1 = call_mapViewWorkFlow('/home/svc/new_github/JPL-WebService/JPL_CMDA/services/svc/svc/static/mapViewWorkFlow/853b0be19a21cf3c2960c4f97f3c613e/data_anomaly.nc', './', '0')
    mesg = c1.display_mapViewWorkFlow()
    print 'mesg: ', mesg
