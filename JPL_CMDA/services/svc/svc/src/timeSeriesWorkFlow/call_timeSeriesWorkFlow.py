...
class call_timeSeriesWorkFlow:
    ...
    def display_timeSeriesWorkFlow(self):
...
if __name__ == '__main__':
    # test nominal case
    #c1 = call_timeSeriesWorkFlow('/ ncc_noresm ta 50000 100,140 -20,20 ncc_noresm ta 70000 240,260 -20,20 ncc_noresm ta 60000 160,240 -40,-20 ncc_noresm ts -999999 40,200 20,40 199001 200312', './', '0')
    # test direct input data file case
    c1 = call_timeSeriesWorkFlow('/home/svc/new_github/JPL-WebService/JPL_CMDA/services/svc/svc/static/anomaly/597fd99118b973cda4408635976fdda3/data_anomaly.nc', './', '0')
    mesg = c1.display_timeSeriesWorkFlow()
    print 'mesg: ', mesg
